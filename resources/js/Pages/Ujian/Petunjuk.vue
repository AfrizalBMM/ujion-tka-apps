...
<template>
	<Head title="Petunjuk Ujian — Ujion" />
			...
			<div class="rounded-3xl border border-white/80 bg-white/90 p-6 shadow-card">
				...
				<div class="mt-5 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-4">
					...
					<ul class="space-y-1.5 text-sm text-amber-900">
						...
						<li v-if="mapel.is_survey">• Pilih jawaban yang paling menggambarkan kondisi atau kebiasaan Anda.</li>
						...
						<li v-if="mapel.petunjuk_khusus">• {{ mapel.petunjuk_khusus }}</li>
					</ul>
				</div>
