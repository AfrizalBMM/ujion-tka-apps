...
<div class="space-y-6">
    <section class="page-hero">
        ...
        <p class="page-description">Anda dapat meninjau dan mengelola butir soal pada mapel yang sesuai dengan jenjang Anda.</p>
    </section>
        ...
        @foreach($paket->mapelPakets as $mapel)
            <article class="card">
                <div class="section-heading mb-4">
                    ...
                    <a href="{{ route('guru.soal.index', [$paket, $mapel]) }}" class="btn-primary px-4 py-2 text-xs">Kelola</a>
                </div>
