...
Route::post('/ngadimin/login', [GeneralAuthController::class, 'adminLogin'])->middleware('throttle:5,1');
...
Route::prefix('superadmin')
    ...
    ->group(function () {
        ...
        Route::get('/wa-pesan-otomatis', [WhatsAppAutoMessageController::class, 'index'])->name('wa-templates.index');
        Route::get('/wa-pesan-otomatis/tambah', [WhatsAppAutoMessageController::class, 'create'])->name('wa-templates.create');
        Route::post('/wa-pesan-otomatis', [WhatsAppAutoMessageController::class, 'store'])->name('wa-templates.store');
        Route::get('/wa-pesan-otomatis/{template}/edit', [WhatsAppAutoMessageController::class, 'edit'])->name('wa-templates.edit');
        Route::post('/wa-pesan-otomatis/{template}', [WhatsAppAutoMessageController::class, 'update'])->name('wa-templates.update');
        Route::post('/wa-pesan-otomatis/{template}/toggle', [WhatsAppAutoMessageController::class, 'toggle'])->name('wa-templates.toggle');
        Route::post('/wa-pesan-otomatis/{template}/delete', [WhatsAppAutoMessageController::class, 'destroy'])->name('wa-templates.destroy');
        ...
        Route::get('/chat/{chat}/image', [ChatImageController::class, 'show'])->name('chat.image');
        Route::post('/chat/{chat}/destroy', [ChatController::class, 'destroy'])->name('chat.destroy');
        Route::post('/chat/{user}/destroy-all', [ChatController::class, 'destroyAll'])->name('chat.destroyAll');
        Route::post('/chat/destroy-all-guru', [ChatController::class, 'destroyAllGuru'])->name('chat.destroyAllGuru');
        ...
        Route::get('/exams/{exam}/analysis/export/csv', [ExamAnalysisController::class, 'exportCsv'])->name('exams.analysis.export-csv');
        Route::get('/exams/{exam}/analysis/print', [ExamAnalysisController::class, 'print'])->name('exams.analysis.print');
